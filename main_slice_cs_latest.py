...
def initialize_and_personalize_activities(df, individual):
    ...
    activities_array[0].charge_mode = 0
    activities_array[0].is_charging = 0
    activities_array[0].is_service_station = 0  # double check home activity is not service station
    ...
    activities_array[max_num_activities - 1].charge_mode = 0
    activities_array[max_num_activities - 1].is_charging = 0
    activities_array[max_num_activities - 1].is_service_station = 0
    ...
    activities_array[max_num_activities - 2].charge_mode = 0
    activities_array[max_num_activities - 2].is_charging = 0
    activities_array[max_num_activities - 2].is_service_station = 0
    ...
    activities_array[max_num_activities - 3].charge_mode = 0
    activities_array[max_num_activities - 3].is_charging = 0
    activities_array[max_num_activities - 3].is_service_station = 0
    ...
    for index, row in df.iterrows():
        ...
        activities_array[activity_index].charge_mode = row["charge_mode"]
        activities_array[activity_index].is_charging = row["is_charging"]
        activities_array[activity_index].is_service_station = row["is_service_station"]
