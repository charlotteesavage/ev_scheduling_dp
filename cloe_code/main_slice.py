...
activity_types = ["Home", "Education", "Work", "Secondary"]
group_to_type = {0: "Home", 1: "Education", 2: "Work", 3: "Secondary"}
groups = ["Home", "Education", "Work", "Secondary"]

# Create output directory if it doesn't exist
output_dir = f"/home/ccortes/Modeling-Individual-Activity-Schedules-and-Behavior-Changes-in-COVID-19/Data/3_Generated/"
...
def compile_code():
    compile_command = [
        ...
        "-o",
        "-fPIC",
        f"/home/ccortes/Modeling-Individual-Activity-Schedules-and-Behavior-Changes-in-COVID-19/Optimizer/scheduling_v{SCHEDULING_VERSION}.so",
        f"/home/ccortes/Modeling-Individual-Activity-Schedules-and-Behavior-Changes-in-COVID-19/Optimizer/scheduling_v{SCHEDULING_VERSION}.c",
        "-lm",
    ]
